package com.company.cardsaver.test_support;

import com.company.cardsaver.CardSaverApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.cardsaver.screen")
@ContextConfiguration(classes = {CardSaverApplication.class, UiTestAssistConfiguration.class})
